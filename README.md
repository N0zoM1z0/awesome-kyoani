...
- [Catalogs and Databases](#catalogs-and-databases)
- [Production and Animation](#production-and-animation)
- [Staff and Creators](#staff-and-creators)
...
_Official Kyoto Animation websites, catalogs, stores, publishing resources, channels, and project pages._

- [KyoAni Shop!](https://kyoanishop.com/) - Kyoto Animation's official online store for home video, books, art and production-related goods, merchandise, and KA Esuma Bunko titles.
- [KyoaniChannel](https://www.youtube.com/@KyoaniChannel) - Kyoto Animation's official YouTube channel for trailers, commercials, project announcements, music videos, making-of features, and other studio videos.
- [Kyoto Animation Corporate Profile](https://www.kyotoanimation.co.jp/en/company/profile/) - Official company facts covering the studio's founding, business activities, headquarters, and corporate leadership.
- [Kyoto Animation Information Archive](https://www.kyotoanimation.co.jp/information/) - The studio's official archive of announcements, shop updates, and event news, with category and year-based browsing.
- [Kyoto Animation Official Website](https://www.kyotoanimation.co.jp/) - The studio's main first-party hub for news, company information, recruitment, events, works, staff content, publishing, and official shop links.
- [Kyoto Animation Professional Training School](https://www.kyotoanimation.co.jp/school/) - The studio-run training program for animation and background art, with courses taught by active Kyoto Animation creators and information on curriculum and applications.
- [Kyoto Animation Recruitment](https://www.kyotoanimation.co.jp/recruit/) - The studio's official careers portal with workplace information, role guides, current recruitment categories, application requirements, and employment details.
- [Kyoto Animation Works](https://www.kyotoanimation.co.jp/en/works/) - The official filmography of Kyoto Animation productions, with release information and title pages covering staff, cast, and official links.

## Catalogs and Databases

_Structured references for Kyoto Animation works, credits, releases, staff, and production information._
...
- [Kyoto Animation's Exception to Industry Norms](https://blog.sakugabooru.com/2023/08/21/kyoto-animations-exception-to-industry-norms-and-the-dedication-to-animation-as-writing-eupho-ova/) - Uses *Sound! Euphonium: Ensemble Contest* to examine Kyoto Animation's production scheduling, acting-focused animation, and treatment of animation as part of the writing process.
- [Kyoto Animation Job Profiles](https://www.kyotoanimation.co.jp/recruit/job/) - Official descriptions of animation, digital paint, background, photography and 2DCG, 3DCG, management, publishing, web, and other studio roles.
- [Kyoto Animation Professional Training School Blog](https://www.kyotoanimation.co.jp/school/blog/) - A Japanese-language official blog with first-hand posts from trainees and instructors about animation study, background art, assignments, and preparation for professional work.
- [The Evolution of Kyoto Animation: A Unique Anime Studio and Its Consistent Vision](https://blog.sakugabooru.com/2018/08/25/the-evolution-of-kyoto-animation-a-unique-anime-studio-and-its-consistent-vision/) - Traces Kyoto Animation's development from subcontracting work to full productions and its distinctive in-house creative and production model.

## Staff and Creators

_High-quality resources about directors, animators, designers, writers, and other creators with a substantial Kyoto Animation connection._
...
_Documented real-world locations, maps, guides, and research connected to settings and places depicted in Kyoto Animation works._

- [Anime Pilgrimage](https://www.animepilgrimage.com/maps) - Maintains scene-level real-world location maps for many Kyoto Animation works, including *Hyouka*, *K-On!*, *Sound! Euphonium*, *Free!*, *A Silent Voice*, and *Beyond the Boundary*.
...
- [Empirical Hibikeology](https://github.com/Shelling0/EmpiricalHibikeology) - A Chinese-language episode-by-episode research project comparing Kyoto Animation's *Sound! Euphonium* adaptation with Ayano Takeda's novels.
...
- [Violet Evergarden: The Movie - Making](https://violet-evergarden.jp/special/making/) - An official illustrated walkthrough of one film cut from script and storyboard through layout, key animation, in-betweening, paint, background art, and photography.

## Communities

_Established communities, fan organizations, events, and collaborative resources centered on Kyoto Animation._

- [Global KyoAni Fan Group Map](https://github.com/kyoani-cn/kyoani-groups) - A community-maintained project for mapping and listing Kyoto Animation fan groups by country, region, and city with structured data for contributions.
...
- [KyoAni FR](https://kyoani.fr/) - A French-language fan media project and community dedicated to Kyoto Animation, with studio news, social channels, and community activities.
...
- [Management Strategy for Animation Production Companies in Regional Area](https://kbu.repo.nii.ac.jp/records/3430) - A Japanese academic paper analyzing Kyoto Animation's Uji-based growth, brand value, production-committee participation, rights ownership, and business diversification.
- [Rebuilding Kyoto Animation: Uncompromising Principles, Now and Going Forward](https://blog.sakugabooru.com/2020/07/24/rebuilding-kyoto-animation-uncompromising-principles-now-and-going-forward/) - Examines the studio's recovery after the 2019 attack through its long-standing production principles, workplace structure, training, and institutional culture.
- [The KyoAni School: Decades of Commitment to Training Anime's Next Generations](https://blog.sakugabooru.com/2020/07/19/the-kyoani-school-decades-of-commitment-to-training-animes-next-generations/) - Traces the history of Kyoto Animation's professional school and its role in cultivating animators and production knowledge across generations.
- [Ultimatemegax's Kyoto Animation Archive](https://ultimatemegax.wordpress.com/category/news/kyoto-animation/) - A long-running English-language archive of Kyoto Animation production histories and translations of staff interviews, fanbooks, pamphlets, and event materials.
...
Awesome KyoAni is an unofficial community project and is not affiliated with Kyoto Animation Co., Ltd.
